...
class ColorResources {
  ...
  static const Map<int, Color> colorMap = {
    50: Color(0xFFE0F4E8), // Very light shade of primary color
    100: Color(0xFFC1E2D3), // Light shade of primary color
    200: Color(0xFFA2D0BD), // Lighter primary shade
    300: Color(0xFF83BE9B), // Mid shade
    400: Color(0xFF6EB7A7), // Primary color lightened
    500: Color(0xFF3CB67D), // Primary color
    600: Color(0xFF35A67B), // Slightly darker primary color
    700: Color(0xFF2F9A6F), // Darker shade
    800: Color(0xFF298664), // Even darker
    900: Color(0xFF1A6B52), // Darkest shade
  };

  static const MaterialColor primaryMaterial =
      MaterialColor(0xFF3CB67D, colorMap);
  static const List<Color> flashDealGradientColorList = [
    Color(0xFF83BE9B), // Lighter shade of primary color
    Color(0xFF3CB67D), // Primary color
    Color(0xFF298664), // Darker shade of primary color
  ];
}

...
class AppConstants {
  static const String appName = 'Mazzraati';
...
//   static const String baseUrl = 'https://mazzraati.tptc.com.sa/v5';
  ...
  static const String sendOtp = '/api/v1/auth/get-phone-otp';
  static const String verifyPhone = '/api/v1/auth/verify-phone-otp';

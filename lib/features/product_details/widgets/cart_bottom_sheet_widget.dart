...
class CartBottomSheetWidgetState extends State<CartBottomSheetWidget> {
  ...
  Widget build(BuildContext context) {
    ({double? end, double? start})? priceRange =
        ProductHelper.getProductPriceRange(widget.product);
          ...
          child: Consumer<ProductDetailsController>(
            builder: (ctx, details, child) {
              ...
              if (widget.product != null &&
                  widget.product!.colorImagesFullUrl != null &&
                  widget.product!.colorImagesFullUrl!.isNotEmpty) {
                for (int i = 0;
                    i < widget.product!.colorImagesFullUrl!.length;
                    i++) {
                  if (widget.product!.colorImagesFullUrl![i].color ==
                      '${widget.product!.colors?[details.variantIndex ?? 0].code?.substring(1, 7)}') {
                    colorWiseSelectedImage =
                        widget.product!.colorImagesFullUrl![i].imageName?.path;
                  }
                }
              }
              ...
              if (widget.product?.digitalProductExtensions != null) {
                widget.product?.digitalProductExtensions?.keys.forEach((key) {
                  ...
                  extentions
                      .add(widget.product?.digitalProductExtensions?[key]);
                });
              }
              ...
              if (variationFileType.isNotEmpty && extentions.isNotEmpty) {
                variantKey =
                    '${variationFileType[details.digitalVariationIndex!]}-${extentions[details.digitalVariationIndex!][details.digitalVariationSubindex!]}';
                for (int i = 0;
                    i < widget.product!.digitalVariation!.length;
                    i++) {
                  if (widget.product!.digitalVariation?[i].variantKey ==
                      variantKey) {
                    price = double.tryParse(
                        widget.product!.digitalVariation![i].price.toString());
                  }
                }
              }
                                    ...
                                    child: Column(
                                      ...
                                      Column(
                                          ...
                                          children: [
                                            CustomDirectionalityWidget(
                                              child: Text(
                                                  '${startingPrice != null ? PriceConverter.convertPrice(context, startingPrice, discount: widget.product?.discount, discountType: widget.product?.discountType) : ''}'
                                                  '${endingPrice != null ? ' - ${PriceConverter.convertPrice(context, endingPrice, discount: widget.product?.discount, discountType: widget.product?.discountType)}' : ''}',
                                                  style: titilliumRegular.copyWith(
                                                      color: Theme.of(context)
                                                          .primaryColor,
                                                      fontSize: Dimensions
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (ctx, index) {
                                return Row(
                                    ...
                                    children: [
                                      Text(
                                          '${variationFileType[index][0].toUpperCase() + variationFileType[index].substring(1)} : ',
                                          style: titilliumRegular.copyWith(
                                              fontSize:
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: GridView.builder(
                                            ...
                                            itemBuilder: (ctx, i) {
                                              bool isSelect = (details
                                                          .digitalVariationIndex ==
                                                      index &&
                                                  details.digitalVariationSubindex ==
                                                      i);
                                              return InkWell(
                                                splashColor: Colors.transparent,
                                                onTap: () => details
                                                    .setDigitalVariationIndex(
                                                        widget.product!
                                                            .minimumOrderQty,
                                                        index,
                                                        i,

...
class ProductController extends ChangeNotifier {
  ...
  bool? _hasData;
  final List<Product> _originalProductList = [];

  List<Product> get brandOrCategoryProductList => _brandOrCategoryProductList;
  List get originalProductList => _originalProductList;
  ...
  //         (product) => _originalProductList.add(Product.fromJson(product)));
  //     _brandOrCategoryProductList.addAll(_originalProductList);
  ...
  //! void dfilterProductPrice(
  //     {double? minPrice, double? maxPrice, String sortOrder = 'asc'}) {
  //   _brandOrCategoryProductList.clear();
  //   List<Product> filteredList = _originalProductList.where((product) {
  ...
  //     }
  //     if (maxPrice == null) {
  //       return product.unitPrice! >= minPrice;
  //     }
  //     return product.unitPrice! >= minPrice && product.unitPrice! <= maxPrice;
  //   }).toList();

  //   if (sortOrder == 'asc') {
  //     filteredList.sort((a, b) => a.unitPrice!.compareTo(b.unitPrice!));
  //   } else if (sortOrder == 'desc') {
  //     filteredList.sort((a, b) => b.unitPrice!.compareTo(a.unitPrice!));
  //   }

  //   _brandOrCategoryProductList.addAll(filteredList);
  //   _hasData = _brandOrCategoryProductList.isNotEmpty;
  //   notifyListeners();
  // }
  ...
  void sortProducts(String sortOrder) {
    _brandOrCategoryProductList.clear();
    List<Product> sortedList = List.from(_originalProductList);

    if (sortOrder == 'asc') {
      sortedList.sort((a, b) => a.unitPrice!.compareTo(b.unitPrice!));
    } else if (sortOrder == 'desc') {
      sortedList.sort((a, b) => b.unitPrice!.compareTo(a.unitPrice!));
    }

    _brandOrCategoryProductList.addAll(sortedList);
    _hasData = _brandOrCategoryProductList.isNotEmpty;
    notifyListeners();
  }

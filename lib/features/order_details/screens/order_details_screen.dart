...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  void _loadData(BuildContext context) async {
    if (Provider.of<AuthController>(context, listen: false).isLoggedIn() &&
        !widget.fromTrack) {
      await Provider.of<OrderDetailsController>(Get.context!, listen: false)
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
          ...
          body: Consumer<SplashController>(builder: (context, config, _) {
                      ...
                      return (orderProvider.orderDetails != null &&
                          ...
                          ? ListView(
                              ...
                              children: [
                                ...
                                config.configModel?.orderVerification == 1 &&
                                        orderProvider.orders!.orderType != 'POS'
                                    ? Padding(
                                        ...
                                        child: Row(
                                          mainAxisAlignment: orderProvider
                                                      .orders!.orderType !=
                                                  'POS'
                                ...
                                orderProvider.orders != null &&
                                        orderProvider.orders!.orderNote != null
                                    ? Padding(
                                        padding: const EdgeInsets.all(
                                ...
                                orderProvider.orders!.deliveryServiceName !=
                                        null
                                                      ...
                                                      onTap: () {
                                                        showDialog(
                                                            ...
                                                            builder: (_) =>
                                                                ImageDialog(
                                                                    imageUrl:
                                                                        '${orderProvider.orderDetails![0].verificationImages?[index].imageFullUrl?.path}'));
                                                      },
                                                      child: Padding(

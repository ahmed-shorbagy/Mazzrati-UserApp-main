          ...
          ? Center(
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                BouncyWidget(
                    ...
                    child: SizedBox(
                        width: 150,
                        child: Image.asset(Images.mazzratiLogo, width: 150.0))),
